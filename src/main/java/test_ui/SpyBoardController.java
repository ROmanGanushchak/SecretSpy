...
public class SpyBoardController {
    ...
    public void initialize() {
        ...
        Image image = new Image(getClass().getResourceAsStream("images/spyCardsBoard.png"));
        ...
        this.spyCardImage = new Image(getClass().getResourceAsStream("images/spyCard.png"));
    }
