...
public class LiberalBoardController {
    ...
    public void initialize() {
        ...
        Image image = new Image(getClass().getResourceAsStream("images/liberalsCardsBoard.png"));
        ...
        this.cardImage = new Image(getClass().getResourceAsStream("images/liberalCard.png"));
    }
